...
#define T3MATH_2PI        6.283185307f
#define T3MATH_PI_DIV2    1.570796327f
#define T3MATH_PI_DIV4     0.785398163f;
#define T3MATH_1DIV_PI     0.31830988618379067154f
#define T3MATH_1DIV_2PI    0.15915494309189533577f
#define T3MATH_1DIV_4PI    0.07957747154594766788f
