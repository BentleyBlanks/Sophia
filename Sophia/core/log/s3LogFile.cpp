...
std::ofstream* s3LogFile::ofile = new std::ofstream();
std::ifstream* s3LogFile::ifile = new std::ifstream();

// not supported UTF8
//#define S3_LOG_UTF8

//a3LogFile::a3LogFile()/* : level(S3_LOG_LEVEL_ALLMESSAGES)*/
//{
//
//}
...
void s3LogFile::log(s3LogLevel logLevel, const char* prefix, const char* suffix, const char* message, va_list args)
{
...
void s3LogFile::log(s3LogLevel logLevel, const char* message, va_list args)
{
    //a3LogFile* gLog = a3LogFile::getInstance();
    //s3LogLevel level = gLog->level;
    //std::ofstream* ofile = gLog->file;
    ...
    switch(logLevel)
    {
    case S3_LOG_LEVEL_FATALERROR: lv = "System"; break;
    case S3_LOG_LEVEL_ERROR: lv = "Error"; break;
    case S3_LOG_LEVEL_SERIOUSWARNING: lv = "SeriousWarning"; break;
    case S3_LOG_LEVEL_WARNING: lv = "Warning"; break;
    case S3_LOG_LEVEL_SUCCESS: lv = "Success"; break;
    case S3_LOG_LEVEL_INFO: lv = "Info"; break;
    case S3_LOG_LEVEL_DEV: lv = "Dev"; break;
...
void s3LogFile::log(s3LogLevel logLevel, const char* prefix, const char* suffix, const char* message, ...)
{
    va_list args;
...
void s3LogFile::log(s3LogLevel logLevel, const char* message, ...)
{

}

//s3LogLevel a3LogFile::getLogLevel()
//{
//    return level;
//}
//
//void a3LogFile::setLogLevel(s3LogLevel logLevel)
//{
//    if(level != S3_LOG_LEVEL_NONE)
//        level = logLevel;
//}

void s3LogFile::fatalError(const char* prefix, const char* suffix, const char* message ...)
{
    va_list args;
    va_start(args, message);
    log(S3_LOG_LEVEL_FATALERROR, prefix, suffix, message, args);
    va_end(args);
}

void s3LogFile::fatalError(const char* message, ...)
{
    va_list args;
    va_start(args, message);
...
void s3LogFile::error(const char* prefix, const char* suffix, const char* message ...)
{
    va_list args;
    va_start(args, message);
    log(S3_LOG_LEVEL_ERROR, prefix, suffix, message, args);
    va_end(args);
}

void s3LogFile::error(const char* message, ...)
{
    va_list args;
    va_start(args, message);
...
void s3LogFile::seriousWarning(const char* prefix, const char* suffix, const char* message ...)
{
    va_list args;
    va_start(args, message);
    log(S3_LOG_LEVEL_SERIOUSWARNING, prefix, suffix, message, args);
    va_end(args);
}

void s3LogFile::seriousWarning(const char* message, ...)
{
    va_list args;
    va_start(args, message);
...
void s3LogFile::warning(const char* prefix, const char* suffix, const char* message ...)
{
    va_list args;
    va_start(args, message);
    log(S3_LOG_LEVEL_WARNING, prefix, suffix, message, args);
    va_end(args);
}

void s3LogFile::warning(const char* message, ...)
{
    va_list args;
    va_start(args, message);
...
void s3LogFile::success(const char* prefix, const char* suffix, const char* message ...)
{
    va_list args;
    va_start(args, message);
    log(S3_LOG_LEVEL_SUCCESS, prefix, suffix, message, args);
    va_end(args);
}

void s3LogFile::success(const char* message, ...)
{
    va_list args;
    va_start(args, message);
...
void s3LogFile::info(const char* prefix, const char* suffix, const char* message ...)
{
    va_list args;
    va_start(args, message);
    log(S3_LOG_LEVEL_INFO, prefix, suffix, message, args);
    va_end(args);
}

void s3LogFile::info(const char* message, ...)
{
    va_list args;
    va_start(args, message);
...
void s3LogFile::dev(const char* prefix, const char* suffix, const char* message ...)
{
    va_list args;
    va_start(args, message);
    log(S3_LOG_LEVEL_DEV, prefix, suffix, message, args);
    va_end(args);
}

void s3LogFile::dev(const char* message, ...)
{
    va_list args;
    va_start(args, message);
...
void s3LogFile::debug(const char* prefix, const char* suffix, const char* message ...)
{
    va_list args;
    va_start(args, message);
    log(S3_LOG_LEVEL_DEBUG, prefix, suffix, message, args);
    va_end(args);
}

void s3LogFile::debug(const char* message, ...)
{
    va_list args;
    va_start(args, message);
